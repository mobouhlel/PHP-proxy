...
?>
  <form method="post" action="<?php echo  htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>">
    <ul id="form">
	 ...
	 <font id="box"><center><input id="textbox" type="text" name="<?php echo $GLOBALS['_config']['url_var_name'] ?>" value="<?php echo isset($GLOBALS['_url']) ? htmlspecialchars($GLOBALS['_url']) : '' ?>" onfocus="this.select()"  placeholder="http://anysite.com"/></font> <input id="go" type="submit" value="Surf" /></li></center>
     <br /><center>
...
<p align="right">
      ...
      Design by <a href="team/abdullah" ><font color="#FFFF00" style="normal">Abdullah Hussam</font></a>&nbsp;&nbsp;&nbsp;
